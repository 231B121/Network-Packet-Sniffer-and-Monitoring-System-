...
2. **Run the Packet Sniffer**
   ...
   > **Note:** Administrator or root privileges may be required for live packet capture. On Linux, you may need to run with `sudo`. On Windows, run the terminal as Administrator.
